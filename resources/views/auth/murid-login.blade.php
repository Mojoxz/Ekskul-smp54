<!-- resources/views/auth/murid-login.blade.php -->
@extends('layouts.app')
...
<div class="max-w-md mx-auto bg-white rounded-lg shadow-lg p-6">
    ...
    <form method="POST" action="{{ route('murid.login.post') }}">
        @csrf
        <div class="mb-4">
        ...
        <div class="mb-6">
            ...
            <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('ekskul_id') border-red-500 @enderror"
                    id="ekskul_id" name="ekskul_id" required>
